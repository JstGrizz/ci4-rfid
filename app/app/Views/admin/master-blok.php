...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Master Blok</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('master-blok/add'); ?>" class="btn btn-success float-end">Tambah
                                Data</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1" style="width: 100%; text-align: center;">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;">Nama Blok</th>
                                ...
                                <tbody>
                                    <?php foreach ($bloks as $blok): ?>
                                        <tr>
                                            ...
                                            <td><?= $blok['estate']; ?></td>
                                            <td>
                                                <a href="<?= base_url('master-blok/edit/' . $blok['blok_id']); ?>"
                                                    class="btn btn-primary"><i class="bi bi-pencil"></i></a>
                                                <button onclick="deleteBlok('<?= $blok['blok_id']; ?>')"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            window.deleteBlok = function(blok_id) {
                if (confirm('Apakah Anda yakin ingin menghapus blok ini?')) {
                    fetch(`<?= base_url('master-blok/'); ?>${blok_id}`, {
                            method: 'DELETE',
                            headers: {

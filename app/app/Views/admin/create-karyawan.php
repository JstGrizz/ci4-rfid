...
<body>
        ...
        <div id="main">
            ...
            <div class="page-heading">
                            ...
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a href="<?= base_url('master-karyawan'); ?>">Master Karywan</a>
                                    </li>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <form id="create-karyawan-form" method="post">
                                <?= csrf_field() ?>
                                <div class="mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const createForm = document.getElementById('create-karyawan-form');
            ...
            createForm.addEventListener('submit', function(event) {
                ...
                fetch('<?= base_url('master-karyawan/create'); ?>', {
                        method: 'POST',
                        headers: {

                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('group-karyawan'); ?>">Group
                                            Karyawan</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="create-group-form" method="post"
                                action="<?= base_url('group-karyawan/create'); ?>">
                                <?= csrf_field() ?>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="tipe_group" name="tipe_group">
                                        ...
                                        <option value="rawat pohon">Rawat Pohon</option>
                                        <option value="rawat buah">Rawat Buah</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                ...
                fetch(createForm.action, {
                    ...
                    .then(({
                        ...
                        if (status >= 200 && status < 300) {
                            alert(body.message);
                            window.location.href = '<?= base_url('group-karyawan'); ?>';
                        } else {
                            alert(`Error ${status}: ${body.messages.message}`);
                        }
                    })
                    .catch(error => {

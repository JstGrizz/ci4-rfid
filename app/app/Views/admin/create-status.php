                            ...
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a href="<?= base_url('master-status'); ?>">Master Status</a>
                                    </li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            createForm.addEventListener('submit', function(event) {
                ...
                fetch('<?= base_url('master-status/create'); ?>', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        alert(data.message);
                        if (data.success) {
                            window.location.href = '<?= base_url('master-status'); ?>';
                        }
                    })
                    .catch(error => {
                        console.error('Error:', error);
                        alert('Gagal menambahkan status: ' + error.message);
                    });
            });
        });
    </script>

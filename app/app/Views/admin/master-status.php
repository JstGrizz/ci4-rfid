                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Master Status</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('master-status/add'); ?>" class="btn btn-success float-end">Tambah
                                Data</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($statuses as $status): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('master-status/edit/' . $status['status_id']); ?>"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            window.deleteStatus = function(statusId) {
                if (confirm('Apakah Anda yakin ingin menghapus status ini?')) {
                    fetch(`<?= base_url('master-status/'); ?>${statusId}`, {
                            method: 'DELETE',
                            headers: {
